import { N as ensure_array_like, L as escape_html, C as pop, A as push, F as attr, G as bind_props, S as copy_payload, T as assign_payload } from "../../../../chunks/index.js";
...
function _page($$payload, $$props) {
  ...
  function $$render_inner($$payload2) {
    $$payload2.out += `<div class="flex flex-col gap-4 container mx-auto p-4"><div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4"><h2 class="text-2xl font-bold">Operational Plans Management</h2></div> <div class="flex flex-col md:flex-row gap-4 items-start">`;
    ...
    $$payload2.out += `<!----> <div class="flex-1 flex flex-col md:flex-row gap-4"><div class="relative flex-1">`;
    Search($$payload2, {
      class: "absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground",
      size: 20
    });
    $$payload2.out += `<!----> <input type="text"${attr("value", searchQuery)} placeholder="Search objectives..." class="pl-10 pr-4 py-2 bg-secondary border-secondary rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-ring"></div> <button class="flex items-center gap-2 bg-secondary text-foreground px-4 py-2 rounded-lg hover:bg-secondary/80 justify-center md:w-auto">`;
