<script lang="ts">
    ...
    const fetchOpportunitiesData = async () => {
        try {
            ...
            departments.unshift("all"); // Add "all" option
        } catch (error) {
    ...
    const filteredOpportunities = $derived(
        opportunities.filter(
            (opportunity) =>
                (selectedDepartment === "all" || opportunity.department_name === selectedDepartment) &&
                (selectedStatus === "all" ||
    ...
    const generatePDF = () => {
        ...
        const groupedOpportunities = selectedDepartment === "all"
            ...
            <div class="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between mt-4">
                ...
                <div class="flex flex-col md:flex-row gap-4 items-center">
                    <select
                        ...
                        class="px-3 py-2 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
                    >
                ...
                {#each filteredOpportunities as opportunity}
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div class="grid gap-4 md:grid-cols-2 mb-4">
                            ...
                            <div class="p-3 bg-gray-50 rounded">
                                <span class="text-sm font-medium text-gray-600">Planned Actions:</span>
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-200">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                                <div>
                                    <span class="text-sm text-gray-600">Actions Taken to Achieve Opportunity</span>
                                ...
                                <div>
                                    <span class="text-sm text-gray-600">Time Completed</span>
