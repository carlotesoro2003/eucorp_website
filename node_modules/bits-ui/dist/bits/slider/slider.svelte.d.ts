...
declare class SliderThumbState {
    ...
    moveValue: (thumbValue: number, increment: number) => void;
    handleArrowKey: (thumbValue: number, isPositiveDirection: boolean, isHorizontal: boolean, e: KeyboardEvent) => void;
    props: {
        readonly id: string;
